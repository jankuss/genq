...
const TOKEN_ENUM TokenType = "ENUM"

var REGEXP_ENUM = regexp.MustCompile("^enum")
...
const TOKEN_DECIMAL_NUMBER TokenType = "DECIMAL_NUMBER"

var REGEXP_DECIMAL_NUMBER = regexp.MustCompile("^[0-9]*\\.[0-9]+")

const TOKEN_NUMBER TokenType = "NUMBER"

var REGEXP_NUMBER = regexp.MustCompile("^[0-9]+")
...
const TOKEN_EQUALS TokenType = "EQUALS"

var REGEXP_EQUALS = regexp.MustCompile("^\\=")
...
var TOKEN_MAPPINGS = []TokenMapping{
  ...
  {REGEXP_DECIMAL_NUMBER, TOKEN_DECIMAL_NUMBER},
  {REGEXP_NUMBER, TOKEN_NUMBER},
